/**
 * Random Loading Text Generator
 * Displays humorous and engaging loading messages
 * 
...
class LoadingTextGenerator {
  constructor() {
    this.loadingTextRank1 = [
      "We are loading",
      "The server is powered by a lemon and two electrodes. It takes a while ...",
  ...
  /**
   * Get a random loading text based on weighted probability
  ...
  getRandomText() {
    ...
    if (random < 0.5) {
      textArray = this.loadingTextRank1;
    } else if (random < 0.75) {
      textArray = this.loadingTextRank2;
    } else {
      textArray = this.loadingTextAll;
    }
  ...
  /**
   * Display random loading text in specified element
   * @param {string} elementId - ID of the target element
   */
  displayRandomText(elementId) {
...
const loadingGenerator = new LoadingTextGenerator();

/**
 * Global function for backward compatibility
 * @param {string} elementId - ID of the target element
 */
function display_random_loading_text(elementId) {
  loadingGenerator.displayRandomText(elementId);
}

// Export for module usage
if (typeof module !== 'undefined' && module.exports) {
  module.exports = LoadingTextGenerator;
}
